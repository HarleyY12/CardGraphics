...
public class Card {
    ...
    public Card(String suit, String value) {
        ...
        // represents the image that is shown for the corresponding card
        // front of the card, or back of the card
    ...
    // method that is called when there is a left click
    ...
    // represents an image file that is drawn on the screen
    public BufferedImage readImage() {
        try {
            BufferedImage image;
            // if show is true, show the front
            // if show is false, show the back
            if (show) {
